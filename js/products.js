...
const PRODUCTS = [
  ...
  // Streaming y suscripciones (logos sin fondo en images/products/)
  { id: "netflix", name: "Netflix (1 mes)", categoria: ["streaming"], precio: 16, imagen: "netflix.png" },
  { id: "netflix-premium", name: "Netflix Premium (1 mes)", categoria: ["streaming"], precio: 19.5, imagen: "netflix.png" },
  { id: "hbo-max", name: "HBO Max (1 mes)", categoria: ["streaming"], precio: 15, imagen: "hbo-max.png" },
  { id: "prime-video", name: "Prime Video (1 mes)", categoria: ["streaming"], precio: 15, imagen: "prime-video.png" },
  { id: "vix-premium", name: "Vix Premium (1 mes)", categoria: ["streaming"], precio: 14, imagen: "vix-premium.png" },
  { id: "spotify-premium", name: "Spotify Premium (1 mes)", categoria: ["streaming"], precio: 12, imagen: "spotify-premium.png" },
  { id: "disney-plus", name: "Disney+ (1 mes)", categoria: ["streaming"], precio: 15, imagen: "disney-plus.png" },
  { id: "paramount", name: "Paramount+ (1 mes)", categoria: ["streaming"], precio: 14, imagen: "paramount.png" },
  { id: "crunchyroll", name: "Crunchyroll (1 mes)", categoria: ["streaming"], precio: 10, imagen: "crunchyroll.png" },
  { id: "youtube-premium", name: "YouTube Premium (1 mes)", categoria: ["streaming"], precio: 10, imagen: "youtube-premium.png" },
  { id: "expressvpn", name: "ExpressVPN (1 mes)", categoria: ["streaming"], precio: 14, imagen: "expressvpn.png" },
  { id: "epic-games", name: "Epic Games (1 mes)", categoria: ["streaming"], precio: 45, imagen: "epic-games.png" },
  { id: "filmora", name: "Filmora (2 meses)", categoria: ["streaming"], precio: 20, imagen: "filmora.png" },
  { id: "capcut", name: "CapCut Pro (1 mes)", categoria: ["streaming"], precio: 22, imagen: "capcut.png" },
  { id: "chatgpt", name: "ChatGPT Plus", categoria: ["streaming"], precio: null, imagen: "chatgpt.png", nota: "Consultar disponibilidad y precio" },
  { id: "google-one", name: "Google One: Gemini Pro + 5TB", categoria: ["streaming"], precio: null, imagen: "google-one.png", nota: "Consultar disponibilidad y precio" },
